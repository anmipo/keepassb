...
Thanks to Nam T. Nguyen for &lt;a href=&apos;https://bitbucket.org/namn/browsepass/&apos;&gt;BrowsePass&lt;/a&gt;, a nice JavaScript-based KeePass&amp;nbsp;2 port.
    ...
    <message>
        <location filename="../assets/AboutPage.qml" line="85"/>
...
NOTE: A timeout or the main-menu Lock button will activate the Quick Lock (if enabled). However, the bottom-left Lock button always applies the full lock.</source>
        <comment>Information about Quick Lock function. &apos;A hash of&apos; refers to hash function (see wikipedia). &apos;main-menu Lock button&apos; - lock button in the main menu. &apos;bottom-left Lock button&apos; - &apos;Lock button in the specified part of the screen. For other terms, please see thesaurus.</comment>
        <translation type="unfinished"></translation>
    </message>
</context>
<context>
